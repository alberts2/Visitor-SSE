...
args = {
    ...
    'rv_arg'                : {                # loc/scale/shape for param dists
        ...
        'Sample'            : { 'a' : 10**-2,   'b' : 10**-1   },     # 10 to 100 days, rate of 0.01 to 0.1
        ...
        'S0'                : { 'loc' : 50000., 'scale' : 200000. }, # 50000 to 250000 ind. in population
        'R2S'               : { 'loc' : 0.0001, 'scale' : 0.0099 },   # 10000 to 100 days, rate of 0.0001 to 0.01
        'Stop_time'         : { 'loc' : 1.0,    'scale' : 29.0  },     # 5 to 5 days, rate of 0
