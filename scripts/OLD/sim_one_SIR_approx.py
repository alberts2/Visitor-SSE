...
args = {
    ...
    'rv_arg'                : {                # loc/scale/shape for param dists
        ...
        'VisitDepart'       : { 'a' : 10**-10,   'b' : 10**-9   },     # 100 to 1000 days, rate of 0.01 to 0.1
        'VisitReturn'       : { 'a' : 10**-1,   'b' : 10**0    },     # 1 to 10 days, rate of 0.1 to 1
        'S0'                : { 'loc' : 10000000., 'scale' : 0. }, # 50000 to 250000 ind. in population
        'R2S'               : { 'loc' : 0.0001, 'scale' : 0.0099 },   # 10000 to 100 days, rate of 0.0001 to 0.01
        'Stop_time'         : { 'loc' : 2.99,    'scale' : 0.01  },     # 5 to 5 days, rate of 0
