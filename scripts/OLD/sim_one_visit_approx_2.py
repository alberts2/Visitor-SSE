...
args = {
    ...
    'max_num_unsampled_lineages' : 20,      # max_num_taxa * max_num_unsampled_lineages == stopping condition
    ...
    'rv_arg'                : {                # loc/scale/shape for param dists
        ...
        'S0'                : { 'loc' : 250000., 'scale' : 250000. }, # 50000 to 250000 ind. in population
        'R2S'               : { 'loc' : 0.0001, 'scale' : 0.0099 },   # 10000 to 100 days, rate of 0.0001 to 0.01
        'Stop_time'         : { 'loc' : 1.0,    'scale' : 19.0  },     # 5 to 5 days, rate of 0
