...
# get arguments
out_path = './sir_one_visit_approx_9'
prefix = 'out'
idx = 0
if len(sys.argv) >= 2:
    out_path     = sys.argv[1]
...
args = {
    ...
    'rv_arg'                : {                # loc/scale/shape for param dists
        ...
        'VisitDepart'       : { 'a' : 2*(10**-1)/4,   'b' : 2*(10**0)/4   },     # 100 to 1000 days, rate of 0.01 to 0.1
        'VisitReturn'       : { 'a' : 2*(10**-2)/4,   'b' : 2*(10**-1)/4    },     # 1 to 10 days, rate of 0.1 to 1
