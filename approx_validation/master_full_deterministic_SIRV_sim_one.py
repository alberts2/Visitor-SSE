...
args = {
    ...
    'rv_arg'                : {                # loc/scale/shape for param dists
        ...
        'S0'                : { 'loc' : 10**7, 'scale' : 0. },        # 50000 to 250000 ind. in population
        'R2S'               : { 'loc' : 10**-12, 'scale' : 0. },   # Effectively zero rate
        'Stop_time'         : { 'loc' : 20.0,    'scale' : 1.0  },     # 5 to 5 days, rate of 0
